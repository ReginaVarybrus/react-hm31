...
import { fetchEpisode } from "../store/slices/episodeSlices";
    ...
    <div className="Main-div">
      <div>
        <EpisodesEnhancedTable
          data={episodes} // Передаем данные о эпизодов
          count={info?.count || 0} // Передаем количество эпизодов или 0, если информация недоступна
